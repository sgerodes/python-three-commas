...
@logged
@with_py3cw
def get_networks_info_by_id(id):
    """
...
@logged
@with_py3cw
def post_convert_dust_to_bnb_by_id(id):
    """
...
@logged
@with_py3cw
def get_active_trading_entities_by_id(id):
    """
...
@logged
@with_py3cw
def post_sell_all_to_usd_by_id(id):
    """
...
@logged
@with_py3cw
def post_sell_all_to_btc_by_id(id):
    """
...
@logged
@with_py3cw
def get_balance_chart_data_by_id(id):
    """
...
@logged
@with_py3cw
def post_load_balances_by_id(id):
    """
...
@logged
@with_py3cw
def post_pie_chart_data_by_id(id):
    """
...
@logged
@with_py3cw
def post_account_table_data_by_id(id):
    """
...
@logged
@with_py3cw
def get_leverage_data_by_id(id):
    """
